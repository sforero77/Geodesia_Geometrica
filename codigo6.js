...
function get_dat(){
    ...
    z2=ConvertGMSToDD(parseFloat(document.getElementById("z2_grados").value),parseFloat(document.getElementById("z2_minutos").value),parseFloat(document.getElementById("z2_segundos").value),"N");
...
//CORRECCION 1
function cor_1(){
    cor1=((o2-i1)/s)*(180*3600/Math.PI);
return cor1;
}
//CORRECCION 2
function cor_2(){
    cor2=((o1-i2)/s)*(180*3600/Math.PI);
return cor2;
}
//Z1_CORREGIDO
function z1_cor(){
...
function terminos(h1,pa,s){
    z2z1rad=(z2c-z1c)*(Math.PI/180);
    t_a=1+(h1/pa);
    t_b=1+((s/(2*pa))*(Math.tan(z2z1rad/2)));
    t_c=1+((s*s)/(12*pa*pa));
}
//DELTA H
function delt_h(){
    z2z1rad=(z2c-z1c)*(Math.PI/180);
    dh=(s*(Math.tan(z2z1rad/2)*t_a*t_b*t_c));
    return dh;
}
//H2
function alt2(){
...
//MOOSTRAR DATOS
function setData(){
    document.getElementById("corr").innerHTML="Corrección ζ<sub>1</sub>= "+cor1+"<br>Corrección ζ<sub>2</sub>= "+cor2+"<br>ζ<sub>1</sub> corregido = "+ConvertDDtoGMS(z1c)+"<br>ζ<sub>2</sub> corregido = "+ConvertDDtoGMS(z2c) ;
    document.getElementById("term").innerHTML="<br> A ="+t_a+"<br> B ="+t_b+"<br> C ="+t_c;
